...
export default function Form({ isEdit, chapter }) {
    const { data, setData, post, processing, errors } = useForm({
        name_id: chapter?.name_id || '',
        name_en: chapter?.name_en || '',
        desc_id: chapter?.desc_id || '',
        desc_en: chapter?.desc_en || '',
        division: chapter?.division || 'All',
        location: chapter?.location || 'Samarinda',
        photo: null,
        _method: isEdit ? 'PUT' : 'POST'
    });

    const [imagePreview, setImagePreview] = useState(chapter?.photo || null);
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (isEdit) {
            post(route('chapters.update', chapter.id));
        } else {
    ...
    return (
        ...
        >
            <Head title={isEdit ? 'Edit Chapter' : 'Tambah Chapter'} />
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                />
                                {errors.name_id && <p className="mt-1 text-xs text-red-600">{errors.name_id}</p>}
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Contoh: All atau Creative"
                                    className="w-full rounded-xl border-gray-250 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm dark:bg-gray-900 dark:border-gray-700 dark:text-white"
                                />
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Tulis deskripsi chapter dalam Bahasa Indonesia..."
                                    className="w-full rounded-xl border-gray-250 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm dark:bg-gray-900 dark:border-gray-700 dark:text-white"
                                />
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Write chapter description in English..."
                                    className="w-full rounded-xl border-gray-250 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm dark:bg-gray-900 dark:border-gray-700 dark:text-white"
                                />
                        ...
                        <div>
                            ...
                            <div className="mt-1 flex flex-col md:flex-row items-center gap-6">
                                {/* Preview Box */}
                                <div className="w-48 h-36 rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 flex items-center justify-center overflow-hidden relative group">
                                    {imagePreview ? (
                                        <img 
                                            src={imagePreview} 
                                            alt="Preview" 
